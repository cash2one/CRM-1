...
from igetui.protobuf import gt_req_pb2
from igetui.payload.APNPayload import APNPayload, DictionaryAlertMsg
...
class BaseTemplate:
    ...
    def setPushInfo(self, actionLocKey, badge, message, sound, payload,
                    locKey, locArgs, launchImage, contentAvailable=0):
