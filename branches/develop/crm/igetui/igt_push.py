...
from igetui.GtConfig import GtConfig
from igetui.igt_message import IGtAppMessage, IGtListMessage
from igetui.RequestException import RequestException
from igetui.utils.igt_lang_utils import LangUtils
from igetui.utils.AppConditions import AppConditions
...
class IGeTui(object):
    ...
    def pushMessageToSingle(self, message, target, requestId=None):
        ...
        params["pushNetWorkType"] = message.pushNetWorkType  # (0:不限;1:wifi;2:4G/3G/2G)
    ...
    def queryAppPushDataByDate(self, appId, date):
        if not LangUtils.validateDate(date):
