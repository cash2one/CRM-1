...
class Customer(models.Model):
    ...
    def get_projects_name(self):
        return ','.join(self.project_set.all().values_list('name', flat=True))
...
class ImpApply(models.Model):
    ...
    imp_engineer = models.ForeignKey(
            UserCredit, limit_choices_to={'role__role': u'交付经理'},
    ...
    notes = models.TextField(blank=True, verbose_name=u'备注')
    progress = models.IntegerField(choices=PROGRESS_CHOICES, default=20, verbose_name=u'当前阶段')
